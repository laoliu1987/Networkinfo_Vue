<template>
  <div>
    <div>
      <img src="../assets/160972302768859.png" alt="">
    </div>
    <el-dialog
      title="主机网络信息获取系统-管理员登录"
   ...
   <div class="login_container">
    <div class="login_box">
      ...
      <div class="avatar_box" @click="dialogVisible = true">

        <div class="bottom">
          <el-tooltip class="item" effect="dark" content="Click it!" placement="bottom">
        <!--头像--><img src="../assets/login2.jpg" alt />
          </el-tooltip>
